...
declare const NotificationServiceApplication_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class NotificationServiceApplication extends NotificationServiceApplication_base {
